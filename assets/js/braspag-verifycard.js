...
VerifyCard.prototype = {
    ...
    handleWarning(errorData) {
        ...
        alert('Verificação de cartão falhou. ' + errorData?.ProviderReturnMessage || 'Erro crítico no processamento do pagamento');
        throw new Error(errorData?.ProviderReturnMessage || 'Erro crítico no processamento do pagamento');
    },
