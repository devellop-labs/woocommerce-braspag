...
- Name: blocks-checkout/creditcard-blocks.spec.ts >> Blocks Checkout — Cartão de Crédito >> B1.3 — 3DS challenge Visa (modal aparece)
- Location: tests/e2e/blocks-checkout/creditcard-blocks.spec.ts:56:9
