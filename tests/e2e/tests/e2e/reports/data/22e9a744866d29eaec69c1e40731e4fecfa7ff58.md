...
- Name: blocks-checkout/creditcard-blocks.spec.ts >> Blocks Checkout — Cartão de Crédito >> B1.1 — pagamento básico aprovado sem 3DS
- Location: tests/e2e/blocks-checkout/creditcard-blocks.spec.ts:43:9
