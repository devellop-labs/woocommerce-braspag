...
- Name: blocks-checkout/creditcard-blocks.spec.ts >> Blocks Checkout — Cartão de Crédito >> B1.2 — 3DS frictionless Visa (sem modal)
- Location: tests/e2e/blocks-checkout/creditcard-blocks.spec.ts:50:9
