...
- Name: blocks-checkout/boleto-blocks.spec.ts >> Blocks Checkout — Boleto >> B7.2 — linha digitável exibida
- Location: tests/e2e/blocks-checkout/boleto-blocks.spec.ts:36:9
