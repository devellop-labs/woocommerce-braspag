...
add_action('woocommerce_blocks_loaded', function () {
    ...
    require_once WC_BRASPAG_PLUGIN_PATH . '/includes/blocks/abstract/class-wc-braspag-blocks-abstract.php';
    ...
    //require_once WC_BRASPAG_PLUGIN_PATH . '/includes/blocks/payments/class-wc-braspag-blocks-creditcard-sop.php';
    ...
    add_action(
        ...
        function (\Automattic\WooCommerce\Blocks\Payments\PaymentMethodRegistry $payment_method_registry) {
            ...
            //$payment_method_registry->register(new WC_Braspag_Blocks_CreditCard_SOP());
        }
    );
});